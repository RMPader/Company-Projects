...
public class Money
{
	...
	protected static class Builder
	{
		...
		public Builder(int wholeNumber, int decimalNumber)
		{
	...
	protected Money(Builder builder)
	{
		this.wholeNumber = builder.wholeNumber;
		this.decimalNumber = builder.decimalNumber;
